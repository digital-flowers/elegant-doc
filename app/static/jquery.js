(function (e) {
    ...
    e.fn.bxSlider_content = function (r) {
        if (this.length == 0)return this;
        if (this.length > 1) {
            this.each(function () {
                e(this).bxSlider_content(r)
            });
            return this
        }
        var s = {};
        ...
        var f = function () {
            ...
            if (s.children.length < s.settings.minSlides)return false;
        ...
        var l = function () {
            ...
            o.css({width: t, position: "relative"});
            ...
            if (s.settings.preloadImages == "all")r = s.children;
